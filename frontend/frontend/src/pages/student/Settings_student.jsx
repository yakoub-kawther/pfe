...
const Card = ({ title, icon, children }) => (
  <div className="bg-white rounded-2xl border border-gray-100" style={{ padding: "24px 28px", boxShadow: "0 1px 6px rgba(0,0,0,0.05)" }}>
...
export default function Settings_student() {
    ...
    <Student_layout>
      <div style={{ maxWidth:"1100px", margin:"40px auto", fontFamily:"Inter, sans-serif", padding:"0 24px", display:"flex", flexDirection:"column", gap:"24px" }}>
        ...
        <div className="flex items-center justify-between mb-8">
          <h2 style={{ fontSize:"24px", color:"#701366", fontFamily:"Inter, sans-serif", margin:0 }}>Settings</h2>
        </div>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(min(100%, 380px), 1fr))", gap:"24px", alignItems:"start", marginTop:"30px" }}>
          ...
          <div className="flex flex-col" style={{ gap:"24px" }}>
            ...
            <Card title="Account Information">
              <div className="grid grid-cols-1" style={{ gap:"16px", marginTop:"20px" }}>
                <ReadField label="Full Name" value={account?.full_name} />
          ...
          <Card title="Change Password">
            ...
            <div className="grid grid-cols-1" style={{ gap:"18px", marginTop:"20px" }}>
              ...
              <ul className="text-[11px] text-gray-400 font-Inter list-none" style={{ paddingLeft:"0", margin:"0", display:"flex", flexDirection:"column", gap:"4px" }}>
                {[
              ...
              <div className="flex justify-end pt-1">
                <Buttons
                  ...
                  onSave={handleSave}
                  saveLabel={saving ? "Saving..." : "Save Password"}
                />
              </div>
            </div>
          </Card>
