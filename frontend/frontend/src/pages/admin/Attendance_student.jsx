      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
            ...
            <table className="w-full text-sm">
              ...
              <thead>
                <tr className="bg-[#F8E0F8] h-12 text-[#701366] text-left">
                  <th style={{ paddingLeft: "30px" }} className="py-3">Date</th>
              ...
              <tbody className="divide-y divide-[#f8e0f8]">
                {attendanceData.map((item, idx) => (
                  <tr key={idx} className="hover:bg-[#fffafe] h-12">
                    <td style={{ paddingLeft: "30px" }} className="py-3 text-[#701366]">
                      {item.date}
                    </td>

                    <td className="px-4 text-[#701366]">
                      {item.subject}
                    </td>
          ...
          <div className="w-full lg:w-1/3 bg-white rounded-2xl shadow-sm p-6 flex flex-col items-center justify-center">
            ...
            <h3 className="text-[#701366] mb-4 text-xl  font-Inter">
              Attendance Rate
            </h3>
            ...
            <div className="relative w-40 h-40">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-2xl font-Inter text-[#701366]">
                  {percent}%
                </span>
                <span className="text-xs text-[#701366]">
                  Present
                </span>
              </div>
            </div>
