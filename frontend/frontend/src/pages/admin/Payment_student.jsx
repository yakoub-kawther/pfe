      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
            ...
            <table className="w-full text-sm">
              ...
              <thead>
                <tr className="bg-[#F8E0F8] h-12 text-[#701366] text-left">
                  <th className="pr-4 py-3" style={{ paddingLeft: "30px" }}>
                    Language
                  </th>
              ...
              <tbody className="divide-y divide-[#f8e0f8]">
                {paymentData.map((item, idx) => (
                  <tr
                    key={idx}
                    className="hover:bg-[#fffafe] transition-colors h-12"
                  >
                    <td
                      className="pr-4 py-3 text-[#701366]"
          ...
          <div className="w-full lg:w-1/3 bg-white rounded-2xl shadow-sm p-6 flex flex-col items-center justify-center">
            ...
            <h3 className="text-[#701366] font-Inter text-xl mb-4">
              Payments Rate
            </h3>
            ...
            <div className="relative w-40 h-40">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-xl font-Inter text-[#701366]">
                  {percent}%
                </span>
              </div>
            </div>
