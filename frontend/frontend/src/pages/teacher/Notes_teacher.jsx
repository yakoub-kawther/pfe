...
export default function Notes_teacher() {
  ...
  return (
    <Teacher_layout>
      <div style={{ maxWidth: "1100px", margin: "40px auto", fontFamily:"Inter" ,padding: "0 24px", display: "flex", flexDirection: "column", gap: "24px" }}>
                  ...
                  >
                    ...
                    <td style={tdStyle}>
                      <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                        <span style={{ fontSize: "15px" }}></span> {cls.students}
                      </div>
                    </td>
