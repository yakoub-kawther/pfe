...
// ─── LOGGED-IN TEACHER ─────────────────────────────────────────
const CURRENT_TEACHER = "Prof. Smith";

// ─── ALL SESSIONS (in a real app, fetched & filtered by teacher ID) ──────────
const allClasses = [
...
// Sessions that belong to the current teacher
const myClasses = allClasses.filter((c) => c.teacher === CURRENT_TEACHER);
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: "clamp(6px, 1vw, 14px)" }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: "0.6rem", color: "#1a1a2e", fontWeight: 500, marginTop: 2 }}>{CURRENT_TEACHER}</div>
