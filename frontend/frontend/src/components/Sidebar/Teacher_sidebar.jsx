...
function Teacher_sidebar() {
  ...
  const navItems = [
    { to: "/Dashboard_teacher",     icon: <LayoutDashboard size={15} />, label: "Dashboard"     },
    { to: "/Classes_teacher",       icon: <BookOpen        size={15} />, label: "Attendance" },
    { to: "/Notes_teacher",       icon: <GraduationCapIcon   size={15} />, label: "Notes" },
    { to: "/Fees_teacher",          icon: <CreditCard      size={15} />, label: "Fees"          },
    { to: "/Profile_teacher",          icon: <User2   size={15} />, label: "Profile"          },
    { to: "/Timetable_teacher",    icon: <Calendar        size={15} />, label: "Time Table"    },
    { to: "/Notifications_teacher", icon: <Bell            size={15} />, label: "Notifications" },
    { to: "/Settings_teacher",      icon: <Settings        size={15} />, label: "Settings"      },
  ];
  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        <img src="/src/assets/Teacher.svg" style={{ width: "clamp(70px, 10vw, 290px)", height: "auto" }} alt="Teacher" />
        <button
